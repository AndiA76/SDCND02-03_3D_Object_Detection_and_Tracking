...
## Process model and Kalman filter configuration parameters
...
sigma_lidar_x = 0.1 # 0.0763 # 0.1 # measurement noise standard deviation for lidar x position   
sigma_lidar_y = 0.1 # 0.0485 # 0.1 # measurement noise standard deviation for lidar y position   
sigma_lidar_z = 0.1 # 0.0785 # 0.1 # measurement noise standard deviation for lidar z position   
